...
HEADERS = audioHelper.h animations.h chaos_game.h barnsley.h mendelbrot.h julia.h
SOURCES = audioHelper.c animations.c window.c chaos_game.c barnsley.c mendelbrot.c julia.c
OBJ = $(SOURCES:.c=.o)
