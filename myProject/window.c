...
static GL4DHanime _animations[] = {
    /*{ 10000, triangle, NULL,NULL },
    { 4000 , transition1, NULL, NULL},
    { 10000, barnsley, NULL,NULL },
    { 5000 , transition0, NULL, NULL},
    { 10000, square, NULL, NULL },
    { 6000 , transition2, NULL, NULL},
    */{ 10000, penta, NULL, NULL },
    { 10000, mendelbrot, NULL,NULL},
    { 4000, julia, NULL,NULL},
...
int main(int argc, char ** argv) {
  ...
  ahInitAudio("audio/July-Somewhere.ogg");
  gl4duwMainLoop();
  return 0;
}
